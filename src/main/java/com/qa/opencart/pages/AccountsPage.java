...
public class AccountsPage {
	...
	private By searchIcon = By.cssSelector("span.input-group-btn");
	...
	public String getAccountsPageUrl() {
		return eleUtil.waitForUrlContains(Constants.ACCOUNTS_URL_FRACTION, Constants.DEFAULT_TIMEOUT);
	}
	...
	public List<String> getAccPageSection() {
